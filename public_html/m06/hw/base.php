...
function printHeader($ucid, $problem) {
    ...
    echo "<p><a href='index.php'>Back to Module 6 Homework</a></p>";
    echo "<h2 style='color: purple;'>Running Problem {$problem} for [{$ucid}] [{$currentDT}]</h2>";
    switch ($problem) {
        case 1:
            echo '<p>Objective: Extract the name, color, and region into a separate multi-dimensional array called $subset.</p>';
            break;
        case 2:
            echo '<p>Objective: Create a new array called $processedCars with the original properties plus age and isClassic. isClassic is a boolean based on today\'s year and the $classic_age variable.</p>';
            break;
        case 3:
            echo '<p>Objective: Join both arrays on the userId property into one $joined array.</p>';
            break;
        default:
            break;
    }
